    ...
    >
      ...
      <DialogContent sx={{ py: 1.5 }}>
        <DialogContentText id="delete-dialog-description" sx={{ color: '#475569', fontSize: '0.95rem' }}>
          Are you sure you want to delete <strong style={{ color: '#0F172A' }}>{supplierName}</strong>? This action cannot be undone and will permanently remove the supplier master record.
        </DialogContentText>
      </DialogContent>
