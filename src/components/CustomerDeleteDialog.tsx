  ...
  return (
    ...
    >
      ...
      <DialogContent sx={{ pb: 2 }}>
        <DialogContentText id="delete-dialog-description" sx={{ color: '#475569', fontSize: '0.925rem' }}>
          Are you sure you want to delete the customer <strong>{customer.customerName}</strong>?
